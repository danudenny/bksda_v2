...
async function main() {
  ...
  const species = await Promise.all([
    prisma.fokusKonservasi.upsert({
      ...
      create: {
        ...
        description: "Harimau Sumatera adalah subspesies harimau yang paling terancam punah.",
        order: 1,
        isActive: true,
      },
    }),
    prisma.fokusKonservasi.upsert({
      ...
      create: {
        ...
        slug: "gajah-sumatera",
        imageUrl: "https://images.unsplash.com/photo-1564349332856-e8e1b3c3f8d8?w=800",
    ...
    prisma.fokusKonservasi.upsert({
      ...
      create: {
        ...
        imageUrl: "https://images.unsplash.com/photo-1444464666175-1642a4d30d60?w=800",
  ...
  const kawasanCategories = await Promise.all([
    ...
    prisma.kawasanCategory.upsert({
      ...
      create: {
        ...
        imageUrl: "https://images.unsplash.com/photo-1501675423372-9bfa95849e62?w=800",
        order: 2,
        isActive: true,
      },
    }),
  ...
  await Promise.all([
    prisma.kawasanLocation.upsert({
      where: { categoryId_slug: { categoryId: kawasanCategories[0].id, slug: "dangku" } },
      update: {},
      create: {
        name: "Dangku",
        slug: "dangku",
    ...
    prisma.kawasanLocation.upsert({
      where: { categoryId_slug: { categoryId: kawasanCategories[0].id, slug: "bentayan" } },
      update: {},
      create: {
        name: "Bentayan",
        slug: "bentayan",
    ...
    prisma.kawasanLocation.upsert({
      where: { categoryId_slug: { categoryId: kawasanCategories[1].id, slug: "punti-kayu" } },
      update: {},
      create: {
        name: "Punti Kayu",
        slug: "punti-kayu",
  ...
  await prisma.siteSettings.upsert({
    ...
    create: {
      id: "global",
      footerAddress: "Jl. Pendidikan No. 123, Palembang, Sumatera Selatan 30139",
      ...
      heroSubtitle: "Bersama menjaga kelestarian satwa liar dan ekosistem",
