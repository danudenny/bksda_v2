...
<template>
    ...
    >
        ...
        <!-- Dialog -->
        <div
            class="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-sm w-full mx-4 p-6 space-y-4"
        >
            <!-- Icon and Title -->
            <div class="flex items-start gap-3">
                <div v-if="options.isDangerous" class="flex-shrink-0 mt-0.5">
                    <AlertCircle
