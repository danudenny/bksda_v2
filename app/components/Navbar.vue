  ...
  >
    ...
    >
      <nav class="flex w-full items-center justify-between py-4 lg:py-5">
        ...
        >
          <div
            class="h-8 w-8 sm:h-10 sm:w-10 overflow-hidden rounded-full group-hover:ring-emerald-300 transition duration-300 flex-shrink-0"
          >
            <NuxtImg
              src="/logo.avif"
          ...
          <div class="hidden sm:flex flex-col leading-tight">
            ...
            <span
              ...
              :class="isScrolled ? 'text-emerald-600' : 'text-emerald-300'"
            >
              Kementerian LHK
            </span>
          </div>
        ...
        <div class="flex items-center gap-2 sm:gap-3">
          ...
          >
            <AlignVerticalJustifyStart
              ...
              aria-hidden="true"
            />
            <span class="hidden sm:inline transition-all duration-500">{{
