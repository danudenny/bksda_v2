      ...
      >
        <div class="md:col-span-2 lg:col-span-5">
          ...
          <div class="mt-6 space-y-2 text-xs">
            ...
            <p>BALAI KONSERVASI SUMBER DAYA ALAM SUMATERA SELATAN</p>
          </div>
        ...
        >
          <div>
            ...
            <ul role="list" class="mt-4 space-y-3">
              <li v-for="item in footerNavigation.profil" :key="item.name">
                <NuxtLink
                  :to="item.href"
          ...
          <div>
            ...
            <ul role="list" class="mt-4 space-y-3">
              <li v-for="item in footerNavigation.kawasan" :key="item.name">
                <NuxtLink
                  :to="item.href"
                  class="text-sm transition-colors duration-300 hover:text-emerald-300"
                  >{{ item.name }}</NuxtLink
          ...
          <div>
            ...
            <ul role="list" class="mt-4 space-y-3">
              <li v-for="item in footerNavigation.tautan" :key="item.name">
                <NuxtLink
                  :to="item.href"
                  class="text-sm transition-colors duration-300 hover:text-emerald-300"
                  >{{ item.name }}</NuxtLink
