  ...
  <section class="relative overflow-hidden bg-white py-12 sm:py-16 lg:py-24">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center">
        ...
        >
          Ikuti perkembangan terkini kegiatan konservasi dan pelestarian alam di
          Sumatera Selatan
        </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div class="flex flex-col justify-center p-8 lg:p-12">
            <div class="flex items-center gap-3">
              ...
              >
                <svg class="h-3 w-3" fill="currentColor" viewBox="0 0 6 6">
      ...
      <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <!-- Image Container -->
          <NuxtLink :to="post.href" class="relative block overflow-hidden">
            <div
