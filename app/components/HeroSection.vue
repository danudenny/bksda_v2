<template>
  ...
  >
    <div class="absolute inset-0 w-full h-full overflow-hidden mt-4 rounded-xl">
      ...
      <div class="flex items-end justify-between gap-4 lg:gap-8">
        <div class="max-w-xl lg:max-w-2xl xl:max-w-3xl">
          <h1
            ...
            style="font-size: clamp(1.875rem, 5vw, 4.5rem); line-height: 1.1"
          >
            Melestarikan Alam,
            <br />
            Menjaga Masa Depan.
          ...
          <p
            ...
            "
          >
            Kami berdedikasi untuk melindungi keanekaragaman hayati dan
            ekosistem unik di Sumatera Selatan melalui konservasi, penelitian,
          ...
          <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            >
              ...
              />
              <span class="whitespace-nowrap">Jelajahi Profil Kami</span>
            </NuxtLink>
            <NuxtLink
              to="/kawasan"
              ...
              style="font-size: clamp(0.875rem, 1.5vw, 1rem)"
            >
              <MountainIcon class="h-4 w-4 sm:h-5 sm:w-5 mr-2 flex-shrink-0" />
              <span class="whitespace-nowrap">Lihat Kawasan Konservasi</span>
            </NuxtLink>
          </div>
        </div>
        ...
        <div class="hidden lg:flex flex-col items-end gap-3 lg:gap-4">
          <div
            class="inline-flex items-center gap-2 lg:gap-3 rounded-xl bg-black/40 backdrop-blur-md px-3 py-3 lg:px-5 lg:py-4 border border-white/20"
          >
            <MapPin
              class="h-4 w-4 lg:h-5 lg:w-5 text-emerald-400 flex-shrink-0"
            />
            <div class="text-left">
              <p
                class="text-emerald-300 font-semibold uppercase tracking-wide"
                style="font-size: clamp(0.625rem, 1vw, 0.75rem)"
              >
                {{ kawasanKonservasi[currentSlide].type }}
              </p>
              <p class="text-base text-white font-bold mt-0.5">
                {{ kawasanKonservasi[currentSlide].name }}
              </p>
              <p class="text-xs text-gray-300 mt-0.5">
                {{ kawasanKonservasi[currentSlide].location }}
              </p>
            </div>
          </div>
    ...
    <div class="absolute z-20 bottom-24 left-1/2 -translate-x-1/2">
      <div class="flex items-center justify-center gap-2">
        <button
          ...
          :class="{
            'h-2 w-12 rounded-full bg-emerald-400': index === currentSlide,
