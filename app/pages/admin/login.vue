    ...
    <div class="grid lg:grid-cols-2 min-h-screen">
        ...
        >
            ...
            <div class="text-center p-8">
                <h2
                    class="text-4xl font-extrabold text-green-700 dark:text-green-400"
                >
                    BKSDA
                </h2>
                ...
                <form @submit="onSubmit" class="mt-6">
                    <div class="grid gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <!-- Button Main Website / Homepage -->
                            <Button variant="outline" class="mt-4 h-10">
                                <NuxtLink to="/"> Kembali ke Website </NuxtLink>
                            </Button>
                        </div>
                    </div>
                </form>
