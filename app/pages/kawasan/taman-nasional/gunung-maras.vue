<template>
    <NuxtLayout name="archive">
        <template #breadcrumb>
            ...
            <NuxtLink to="/kawasan/taman-nasional" class="text-emerald-200 hover:text-white transition-colors">Taman Nasional</NuxtLink>
            <span class="text-emerald-500 mx-2">/</span>
            <span class="text-white">Gunung Maras</span>
        </template>
        <template #header>
