<template>
    <NuxtLayout name="archive">
        <template #breadcrumb>
            ...
            <NuxtLink to="/kawasan/suaka-margasatwa" class="text-emerald-200 hover:text-white transition-colors">Suaka Margasatwa</NuxtLink>
            <span class="text-emerald-500 mx-2">/</span>
            <span class="text-white">Gunung Raya</span>
        </template>
        <template #header>
