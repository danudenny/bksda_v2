...
export const useApi = () => {
    ...
    return {
        ...
        createAnnouncementCategory: (data: any) =>
            request('/announcement-categories', { method: 'POST', data }),
        updateAnnouncementCategory: (id: string, data: any) =>
            request(`/announcement-categories/${id}`, { method: 'PUT', data }),
        deleteAnnouncementCategory: (id: string) =>
            request(`/announcement-categories/${id}`, { method: 'DELETE' }),
        ...
        getKawasanLocationBySlug: (
            ...
            request('/kawasan/public/location', {
                params: { category: categorySlug, slug: locationSlug },
            }),
        // Gallery
        getGalleryImages,
        getGalleryImage,
